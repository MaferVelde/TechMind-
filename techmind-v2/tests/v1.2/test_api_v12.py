...
app = importlib.import_module("techmind_api_v12.main").app
...
def test_predict(client: TestClient) -> None:
    response = client.post(
        ...
        json={
            "texts": [
                "Train a classification model and evaluate precision recall and F1.",
    ...
    assert technical["decision"] in {"accepted", "review"}
