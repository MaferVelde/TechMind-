...
def test_multilingual_regression(
    ...
    texts = [
        ...
        # ES/EN — Frontend
        (
            "Crear un responsive component con CSS Grid "
    ...
    for item, expected in zip(
        ...
        # Los textos técnicos deben conservar soporte de dominio.
...
def test_known_multilingual_operational_behavior(
    ...
    # Casos congelados durante el smoke test original v1.2:
